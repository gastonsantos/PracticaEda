...
public class Grupo02 {
	...
	public void  queSePuedanIncorporarDistintosVehiculos() throws ColitionException{		
		...
		actual.agregarVehiculo(new Moto("094AB5", 200,2, 50.40338, 2.5656));
		...
		actual.agregarVehiculo(new Moto("088BB5", 100, 2,36.85421, 8.17403));
		actual.agregarVehiculo(new Moto("094GG5", 90,2, 29.965482, 4.632152));
	...
	public void  queChoquenDosVehiculos() throws ColitionException{		
		...
		Vehiculo unaMoto = new Moto("094AB5", 200, 2, 25.1234, 1.1234);
