...
public class Moto  extends Vehiculo{
	...
	public Moto(String patente, Integer cANTIDAD_MAXIMA_DE_PASAJEROS, Integer velocidadMaxima, Double Latitud, Double Longitud
			) {
		super(Latitud, Longitud);
		this.patente = patente;
		this.CANTIDAD_MAXIMA_DE_PASAJEROS = cANTIDAD_MAXIMA_DE_PASAJEROS;
